...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes, aspp=True, p_scalar=100.):
        ...
        self.layer9=nn.Conv2d(512,num_classes,kernel_size=1,stride=1,bias=True)
...
def Res_Deeplab(num_classes=2, aspp=True):
    model = ResNet(Bottleneck,[3, 4, 6, 3], num_classes, aspp)
    return model
